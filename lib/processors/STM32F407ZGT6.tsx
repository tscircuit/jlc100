...
export const STM32F407ZGT6 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      supplierPartNumbers={{
  "jlcpcb": [
    "C19156"
      ...
      manufacturerPartNumber="STM32F407ZGT6"
      footprint={<footprint>
...
<silkscreenpath route={[{"x":10.076332400000183,"y":-9.080525399999942},{"x":10.076332400000183,"y":-10.076256199999989},{"x":9.080550800000083,"y":-10.076256199999989}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=050cbb9408dc48c4b7a10f3d7752432f&pn=C19156",
