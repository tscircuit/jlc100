...
export const EFM8BB21F16G_C_QFN20R = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      supplierPartNumbers={{
  "jlcpcb": [
    "C80713"
      ...
      manufacturerPartNumber="EFM8BB21F16G_C_QFN20R"
      footprint={<footprint>
...
<silkscreenpath route={[{"x":-1.7415255999999317,"y":1.8999453999999787},{"x":-1.7415255999999317,"y":1.2505436000001282}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=0fcb41ad7e264837978f4acc1683eb46&pn=C80713",
